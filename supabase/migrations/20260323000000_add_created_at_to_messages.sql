-- Add created_at column to messages table to track when each Telegram message was sent.
-- This is the original message timestamp from Telegram, NOT the insertion time.

ALTER TABLE public.messages
ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ;

-- Update match_messages to return created_at
...
-- Update hybrid_search to return created_at
...
-- Update match_messages_and_questions to return created_at
